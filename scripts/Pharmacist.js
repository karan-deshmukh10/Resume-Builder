...
function addNewExp() {
  ...
  function addNewCerti() {
    ...
    CertiInput.placeholder = "Board Certified Critical Care Pharmacist (BPS)";
    ...
    CertiDescription.placeholder = "Completed Pharmacotherapy Specialist offered by Board of Pharmacy Specialist (BPS)"
  ...
  // ========================certification adding ends here
   ...
   function addNewSkill() {
    ...
    SkillInput.placeholder = "ex:Billing Management";
...
// Clear any existing certification entries before adding new ones
TheraContainer.innerHTML = '<h2>THERAPEUTIC AREAS</h2>';
